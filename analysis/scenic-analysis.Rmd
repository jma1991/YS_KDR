...
```{r}
auc <- auc[, order(sce$cluster_integrated)]
```
...
cluster.palette <- iwanthue(n = nlevels(sce$cluster_integrated))

cluster.palette <- setNames(cluster.palette, levels(sce$cluster_integrated))
...
ann <- list(
  annotation_col = data.frame(
    Cluster = sce$cluster_integrated, 
